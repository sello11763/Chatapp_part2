...
public class LoginTest {
 ...
 @Test
    public void setUp() {
        // Creating Registration object directly this stores the values into the fields
        ...
        // Printing to confirm registeredUser is not null
    ...
    public void testLoginUser_wrongUsername_returnsFalse() {
        Login loginTest = new Login(registeredUser, "wrong", "wrongusername");
        assertFalse(loginTest.loginUser());
    }

    @Test
    public void testLoginUser_wrongUsernameAndPassword_returnsFalse() {
        Login loginTest = new Login(registeredUser, "wrong", "wrongusername and wrongpassword");
        assertFalse(loginTest.loginUser());
    }
